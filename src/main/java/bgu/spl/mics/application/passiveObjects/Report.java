...
public class Report {
	...
	public Report(String missionName,String gadgetName, int Mid, int MPid, List<String> agentsSerialNumbers, List<String> agentsNames,
				  int timeIssued, int timeCreated, int QTime){
